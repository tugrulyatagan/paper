...
First algorithm assigns SFs based on the total number of connected devices, second algorithm assigns SFs by balancing air time of the packets in each SF. Their simulation results show that their proposed algorithms give promising results.
