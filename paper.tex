...
\begin{table}
\centering
\caption{PDR of lowest SF selection and different SF classifier schemes.}
...
\begin{table}
\centering
\caption{Prediction accuracy (\%) of different classifiers.}
